...
async function fetchLeaderboard() {
  ...
  // Dev fallback: service client bypasses RLS (requires VITE_SUPABASE_SERVICE_KEY in .env.local)
  const serviceKey = import.meta.env.VITE_SUPABASE_SERVICE_KEY
  if (!serviceKey) throw new Error('Leaderboard: run scripts/leaderboard_function.sql in Supabase SQL Editor, or add VITE_SUPABASE_SERVICE_KEY to .env.local for local dev')
