  ...
  if (error) return (
    <section className="section">
      <div className="container pv-not-found">
        ...
        <p>{error}</p>
        <Link href="/quizzes" className="pv-not-found-link"><ArrowLeft size={16} /> Back to Quizzes</Link>
      </div>
    </section>
  )
        ...
        <div className="container quiz-taker">
          <div className="pv-results">
            ...
            <div className="pv-results-actions">
              ...
              <Link href="/quizzes"><Button variant="secondary">Back to Quizzes</Button></Link>
            </div>
          </div>
        </div>
      </section>
    ...
    <section className="section">
      <div className="container quiz-taker">
        <div className="quiz-taker-header">
          <Link href="/quizzes" className="pv-back"><ArrowLeft size={14} /> Quizzes</Link>
