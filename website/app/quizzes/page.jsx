      ...
      <div className="container">
        ...
        {currentUser ? (
          <div className="quiz-create-section">
            <Link href="/quizzes/create" className="btn btn-secondary quiz-create-btn">
                ...
                {myQuizzes.map(q => (
                  <div key={q.id} className="quiz-my-card">
                    ...
                    <div className="quiz-my-actions">
                      <Link href={`/quizzes/edit/${q.id}`} className="quiz-icon-btn" title="Edit">
                        <Pencil size={15} />
                      </Link>
          ...
          <div className="quiz-create-section quiz-create-section--guest">
            <p className="quiz-guest-text">
              <Link href="/login" className="quiz-guest-link">Log in</Link> to create and share your own quizzes.
            </p>
          </div>
        )}
      </div>
