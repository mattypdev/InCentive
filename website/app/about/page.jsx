          ...
          <div className="about-team-row">
            ...
            <div className="about-team-group">
              ...
              <div className="about-team-grid">
                <div className="about-person-card">
                  <div className="about-person-photo">
                    <img src="/images/nikhil-baman.jpg" alt="Nikhil Baman" style={{ objectPosition: 'center top', transform: 'scale(1.3)', transformOrigin: 'top center' }} />
                  </div>
                  <h4>Nikhil Baman</h4>
            ...
            <div className="about-team-group">
              ...
              <div className="about-team-grid">
                <div className="about-person-card">
                  <div className="about-person-photo">
                    <img src="/images/bella-parikh.jpg" alt="Bella Parikh" style={{ objectPosition: 'center 15%' }} />
                  </div>
                  <h4>Bella Parikh</h4>
                  ...
                  <div className="about-person-socials">
                    ...
                    <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="about-social-btn about-social-btn--linkedin" aria-label="Bella LinkedIn">
                      <img src="/images/linkedin-logo.jpg" alt="LinkedIn" />
                    </a>
                  </div>
                </div>
